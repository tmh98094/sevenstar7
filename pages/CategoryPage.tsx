...
const CategoryPage: React.FC = () => {
  ...
  const data = GAME_CATEGORIES[categoryKey];
    ...
    <div className="bg-brand-black min-h-screen pt-20">
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2">
                <h2 className="text-3xl font-display font-bold text-white mb-6">About Our {data.title}</h2>
                <p className="text-gray-400 leading-relaxed text-lg mb-8">
                    {data.longDescription}
                </p>
                
                <h3 className="text-xl font-bold text-white mb-4">Why Play {data.title} on SevenStar7?</h3>
            ...
            <div className="bg-brand-dark p-8 rounded-2xl border border-white/5 h-fit">
                <h3 className="text-xl font-bold text-white mb-6">Available Providers</h3>
                ...
                <div className="mt-8 pt-8 border-t border-white/10">
                    <p className="text-sm text-gray-500 mb-4">Ready to start?</p>
                    <a 
                        href={EXTERNAL_LINK}
      ...
      <section className="py-20 bg-brand-dark border-t border-white/5">
        <div className="container mx-auto px-6">
            <h2 className="text-3xl font-bold text-white mb-8">Popular {data.title} Titles</h2>
