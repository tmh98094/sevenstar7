...
export const enTranslations: Translations = {
  ...
  blog: {
    ...
    insightsGuides: 'Insights & Player Guides',
    testLuckTitle: 'PUT YOUR LUCK TO THE TEST',
    testLuckSubtitle: "Malaysians' favorite site with the highest winning odds.",
    relatedGuides: 'Related Guides',
    back: 'Back',
    shareThisGuide: 'Share this guide',
    articleNotFound: 'Article Not Found',
    articleNotFoundDesc: "The guide you're looking for might have been moved.",
  },
  ...
  ui: {
    ...
    googleTranslated: '',
    vipOnly: 'VIP Only',
    officialPartnerLink: 'Official Partner Link',
    officialLicensed: 'Official Licensed Casino Malaysia',
    unmatched: 'UNMATCHED',
    sevenStar: '7-STAR',
  ...
  crocoExclusive: {
    officialPartner: 'OFFICIAL EXCLUSIVE PARTNER',
    heroPitch: 'SevenStar7 is the **sole authorized distributor** of Croco Gaming in Malaysia.',
    soleAuthorized: 'sole authorized distributor',
    exclusiveTitles: 'Exclusive Titles',
    onlyOnSevenstar: 'Only available on SevenStar7',
    higherRtpTitle: 'Higher RTP',
    higherRtpDesc: 'Croco Gaming titles on SevenStar7 feature an exclusive Return-To-Player rate of 98.5%, significantly higher than the industry standard.',
    dailyTournamentsTitle: 'Daily Tournaments',
    dailyTournamentsDesc: 'Participate in daily leaderboards automatically when you play any Croco game. Prize pools up to MYR 50,000 daily.',
    arcadeMechanicsTitle: 'Arcade Mechanics',
    arcadeMechanicsDesc: 'Not just slots—skill-based arcade shooting and adventure games where your decisions impact your winnings.',
    prev: 'Prev',
    next: 'Next',
  },

  partnerProgram: {
    heroTitle: 'SevenStar Partner Program',
    heroSubtitle: 'A profit-sharing system designed specifically for players. Earn lifetime commissions.',
    partnerBenefits: 'Partner Benefits',
    calculateEarnings: 'Calculate Your Earnings',
    calculateSubtitle: 'Estimate your monthly potential based on player activity.',
    benefit1Title: 'Dedicated Dashboard',
    benefit1Desc: 'View performance and profit in real time',
    benefit2Title: 'Auto Settlement',
    benefit2Desc: 'System payout, safe and fast',
    benefit3Title: 'Flexible Model',
    benefit3Desc: 'No restrictions, grow freely',
    benefit4Title: 'Sustainable Income',
    benefit4Desc: 'Expand sub-partners, enjoy lifetime bonus',
    commissionFormula: 'Commission Calculation Formula',
    subPartnerPlan: 'Sub-Partner Commission Plan',
    subPartnerDesc: 'When your referred friend becomes a partner and passes verification, you will automatically become their upline and receive lifetime referral commission (10%) from their earnings.',
    whySevenstar: 'Why Choose SevenStar?',
    paymentTerms: 'Commission Payment Terms',
    totalTurnover: 'Total Monthly Turnover (MYR)',
    totalNetLoss: 'Total Net Loss (MYR)',
    yourTierRate: 'Your Tier Rate',
    estimatedIncome: 'Estimated Monthly Income',
    calculatorNote1: '• Both Total Turnover and Total Net Win/Loss must be met to qualify for the corresponding commission rate.',
    calculatorNote2: '• Negative profit will be carried forward to the next month.',
  },

  vip: {
    heroTitle: 'SevenStar7 VIP Club',
    heroSubtitle: 'Elite privileges for elite players.',
    requirement: 'Requirement',
    inviteOnly: 'Invite Only',
    priorityWithdrawal: 'Priority Withdrawal',
    dedicatedManager: 'Dedicated Account Manager',
    higherLimits: 'Higher Betting Limits',
    birthdayGifts: 'Birthday Gifts',
    luxuryTrips: 'Luxury Holiday Trips',
    joinElite: 'Join the Elite',
    trackingDesc: 'Your gameplay is automatically tracked. Once you meet the turnover requirements, our VIP team will contact you personally.',
  },

  promotions: {
    heroTitle: 'Bonuses & Promotions',
    heroSubtitle: "Maximize your winning potential with Malaysia's most generous bonus structure. Fair turnover requirements and instant crediting.",
    promoCode: 'PROMO CODE',
    claimNow: 'CLAIM NOW',
    termsTitle: 'Terms & Conditions Simplified',
    term1: 'One bonus active at a time.',
    term2: 'Turnover applies to deposit + bonus amount.',
    term3: 'General T&C applies to all promotions.',
    term4: 'Bonuses are valid for 30 days.',
    titles: {
      welcome: '150% Welcome Bonus',
      reload: 'Daily 10% Reload',
      rescue: 'Weekly Rescue Bonus',
      birthday: 'VIP Birthday Gift',
    },
    descriptions: {
      welcome: 'Get up to MYR 888 extra on your first deposit. 12x Turnover only.',
      reload: 'Boost your daily deposit with unlimited 10% bonus. Min deposit MYR 50.',
      rescue: "Claim up to MYR 5,000 if you have a bad week. We've got your back.",
      birthday: 'Exclusive red packet up to MYR 1,888 during your birthday month.',
    },
  },

  categoryPage: {
    about: 'About Our',
    whyPlay: 'Why Play %{category} on SevenStar7?',
    availableProviders: 'Available Providers',
    readyToStart: 'Ready to start?',
    popularTitles: 'Popular %{category} Titles',
  },
};